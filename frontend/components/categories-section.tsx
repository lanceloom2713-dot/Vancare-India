  ...
  const categories: { name: string; href: string; image: string }[] = [
    {
      ...
      image: "https://m.media-amazon.com/images/I/516WDvolQbL._UY1100_.jpg","use client";
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-8">
          {categories.map((category, index) => (
            <Link key={index} href={category.href} className="group block">
              <div className="h-60 flex flex-col justify-between items-center rounded-2xl p-6 text-center transition-all duration-300 hover:scale-105 hover:shadow-lg bg-white border-2 border-blue-500">
                
                {/* Image fixed size & round */}
